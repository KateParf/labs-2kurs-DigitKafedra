...
export namespace Transport {
    ...
    export class Vehicle implements VehicleI {
        ...
        private _OwnerInformation: Owner;
        ...
        constructor(brand: string, model: string, year: number, vin: number, reg: number, owner: Owner) {
            this._Brand = brand;
            this._Model = model;
    ...
    export class Car extends Vehicle implements CarI {
        ...
        constructor(brand: string, model: string, year: number, vin: number, reg: number, owner: Owner, carbody: CarBody, carclass: CarClass) {
    ...
    export class Motorbike extends Vehicle implements MotorbikeI {
        ...
        constructor(brand: string, model: string, year: number, vin: number, reg: number, owner: Owner, frameType: string, forSport: boolean) {
            super(brand, model, year, vin, reg, owner);
    ...
    export interface VehicleStorageI<T extends VehicleI> {
        ...
        getT: () => T[];
        brandSort: () =>  T[];
        surnameSort: (surn: string) =>  T[];
    }

    export class VehicleStorage<T extends VehicleI> implements VehicleStorageI<T> {

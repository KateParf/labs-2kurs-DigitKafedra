...
(function (Personnel) {
    ...
    })(Doc = Personnel.Doc || (Personnel.Doc = {}));
    class Owner {
        get birthDate() {
    ...
    (function (CarBody) {
        ...
        CarBody["car4"] = "\u041F\u0438\u043A\u0430\u043F";
    })(CarBody = Personnel.CarBody || (Personnel.CarBody = {}));
    let CarClass;
    (function (CarClass) {
    ...
    })(CarClass = Personnel.CarClass || (Personnel.CarClass = {}));
    ...
    Personnel.VehicleStorage = VehicleStorage;
})(Personnel || (Personnel = {}));
const owner = new Personnel.Owner("Иванов", "Иван", "Иванович", new Date(2000, 1, 1), Personnel.Doc.DriverLicense, 111, 111);
console.log(owner.ownerInfo());
const car = new Personnel.Car("BMW", "X4", 2014, 11, 22, "Иванов Иван Иванович", Personnel.CarBody.car4, Personnel.CarClass.car4);
